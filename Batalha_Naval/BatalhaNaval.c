...
int main()
{
    ...
    while (1)
    {
        ...
        if (i < 0 || i >= 10 || j < 0 || j > (10 - tamanho))
        {
            ...
            { // percorre o caminho onde o navio será posicionado e verifica se todas as casas estao disponiveis
                if (Casas[i][j + k] != 0)
                {
                    ocupado = 1;
                    conflito = k;
    ...
    for (int linha = 0; linha < 10; linha++)
    {
        ...
        {
            switch (Casas[linha][coluna])
            {
            case 0:
                printf("\033[44;37m %d \033[0m", Casas[linha][coluna]); // faz a agua ser azul
                break;
            case 1:
                printf("\033[42;37m %d \033[0m", Casas[linha][coluna]); // cor do primeiro navio
                break;
            case 2:
                printf("\033[43;37m %d \033[0m", Casas[linha][coluna]); // cor do segundo navio
                break;
            case 3:
                printf("\033[45;37m %d \033[0m", Casas[linha][coluna]); // cor do terceiro navio
                break;
            case 4:
                printf("\033[41;37m %d \033[0m", Casas[linha][coluna]); //cor do quarto navio
                break;
            }
        }
        printf("\n");
